...
public class ContaPagarController {
	...
	public ResponseEntity<ContaPagar> salvarContaPagar(@RequestBody @Valid ContaPagar contaPagar) throws ExceptionLojaki {
		...
		if (contaPagar.getId() == null) {
			...
			if (!contaPagarList.isEmpty()) {
				throw new ExceptionLojaki("Já existe conta a pagar com a descrição informada! " + contaPagar.getDescricao());
			}
		}
